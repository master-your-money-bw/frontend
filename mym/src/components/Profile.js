        ...
        <div className="card-content">
          ...
          {this.state.isUpdating ? (
            <form onSubmit={this.onSubmitForm} className="row">
              ...
              <div className="input-field col s4">
                <label className="active" htmlFor="income">
                  Income
                </label>
                <input
                  required
                  ...
                  onChange={this.onInputChange}
                  name="income"
                  value={this.state.updatedUser.income}
                  id="income"
                />
              </div>
              <div className="input-field col s4">
                ...
                <input
                  ...
                  onChange={this.onInputChange}
                  name="transportation"
                  value={this.state.updatedUser.transportation}
                  id="transportation"
                />
              </div>
              <div className="input-field col s4">
                <label className="active" htmlFor="food">
                  Food
                </label>
                <input
                  required
                  ...
                  onChange={this.onInputChange}
                  name="food"
                  value={this.state.updatedUser.food}
                  id="food"
                />
              </div>
              <div className="input-field col s4">
                <label className="active" htmlFor="clothing">
                  Clothing
                </label>
                <input
                  required
                  ...
                  onChange={this.onInputChange}
                  name="clothing"
                  value={this.state.updatedUser.clothing}
                  id="clothing"
                />
              </div>
              <div className="input-field col s4">
                <label className="active" htmlFor="bills">
                  Bills
                </label>
                <input
                  required
                  ...
                  onChange={this.onInputChange}
                  name="bills"
                  value={this.state.updatedUser.bills}
                  id="bills"
                />
              </div>
              <div className="input-field col s4">
                <label className="active" htmlFor="housing">
                  Housing
                </label>
                <input
                  required
                  ...
                  onChange={this.onInputChange}
                  name="housing"
                  value={this.state.updatedUser.housing}
                  id="housing"
                />
              </div>
              <div className="right-align">
                <div className="col s4 offset-s4">
                  <button className="teal accent-3 btn-small">update</button>
                </div>
                <div className="col s4">
                  <button
                    onClick={this.onToggleUpdate}
